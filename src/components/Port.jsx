...
//horizontalRef 라는 변수를 생성하고 useRef라는 훅으로 초기화하라는 명령어
//sectionsRef라는 변수를 생성하고 useRef라는 훅으로 배열값으로 초기화 하라는 명령어
//useRef() ; react에서 변화는 값을 저장하는 명령어
//useRef(null) : 빈 상태의 값을 저장하라는 명령어(문자, 순자 변수 가능~)
...
//useRef(0) : 숫자를 저장하라는 명령어
    ...
    useEffect(() =>{
        ...
        //.current : useRef 객체의 프로포티(속성): 실제로 참조하고 있는 값
